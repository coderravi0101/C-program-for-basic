...
//  this project made by Ravi kumar singh
#include <iostream>
#include <conio.h>
#include <ctype.h>
#include <cstring>
#include <dirent.h>
#include <fstream>     //thease are hader file which involve these program
#include <process.h>
#include <stdio.h>
#include <stdlib.h>
#include <string>
...
using namespace std;  //these are involve in C++ language already with hader file

void title();           //these are function whopass and call the value                                       
void date();                                                   
int delay();                                                  
...
int adminLogin()
{
    ...
    if (username == "ravi kumar singh" && password == "mom@papa@ravi")//these place we can writeuse id and passward
    {
        adminView();
        getchar();
        delay();
...
int main(int argc, char **argv)
{
    ...
    cout << "\n\n";
    cout << "\t\t\t\t";
    cout << "Prepared By    :    RAVI KUMAR SINGH";
